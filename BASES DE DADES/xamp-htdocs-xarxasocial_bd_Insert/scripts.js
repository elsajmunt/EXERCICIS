...
let vots1 = 0;
let vots2 = 0;
let formulariEnquesta = document.getElementById("formulari_enquesta");
formulariEnquesta.addEventListener("enviar",    // ERROR Canviar Nom "enviar" o "submit"...
function (event) { //FUNCIÓ sense nom. Noms elements PREDETERMINATS. Salta al clicar Submit
  ...
  let nomEnquesta = document.getElementById("titol_enquesta").value.trim(); // NOM ENQUESTA //---------
  let avisNomEnquesta = document.getElementById("avis_titol_enquesta");
...
function afegirFila() {
  ...
  let nomEnquesta = document.getElementById("titol_enquesta").value; // NOM ENQUESTA
  ...
  document.getElementById("titol_enquesta").value = '';
