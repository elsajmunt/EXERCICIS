...
CREATE TABLE `liniapedidos` (
  ...
  CONSTRAINT `IDLiniaComandes_Productes` FOREIGN KEY (`IDProductos`) REFERENCES `productos` (`ID`) ON DELETE NO ACTION ON UPDATE CASCADE
...
-- Dump completed on 2024-09-02 19:20:44
