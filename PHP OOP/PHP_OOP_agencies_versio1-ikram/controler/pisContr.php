...
class pisContr extends Pis{ // Classe Pis està a la carpeta Model
    ...
    //public function signupUser()
            ...
            //insertPis to DB 
            if($this->insertPis($this->nompis, $this->imatge, $this->ubicacio, $this->descripcio ) /*== true*/){ // Funció insertPis està a Model/pis.php
    ...
    // FUNCIONS PER VALIDAR FORMULARI NOU PIS:  <<<<<<<<< acabar!
        ...
        public function mostraPis(){  // FUNCIÓ MOSTRAR PIS/PISOS? <<<<<<<< acabar! ---------------------------------
            
                // Posar Condicions...
                    
                //selectPis to DB 
                if($this->selectPis($this->nompis, $this->imatge, $this->ubicacio, $this->descripcio ) /*== true*/){ // Funció selectPis està a Model/pis.php
                    header("Location: ../view/llista_pisos.php?error=FailedStmt"); // $error = true; Resultat Error!
                }
            }    
